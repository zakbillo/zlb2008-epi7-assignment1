...
\item Positivity: $0 < p(A=1 \mid W) < 1$ for observed strata $W$. Every individual must have a non-zero probability of being assigned or not assigned to the training. 
...
\item $E[Y^1|Black=1] = E[Y^1|A = 1,Black =1]$ (by marginal exchangeability, $Y^a \perp A$) 
...
# Reorder: Covariates -> Treatment -> Outcome
