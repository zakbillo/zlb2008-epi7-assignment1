...
gcomp_model <- glm(re78 ~ treatment + age + education
                   + married + nodegree + re74 + re75,
...
QAW_1 <- predict(gcomp_model, newdata = data_A1, type = "response") 
QAW_0 <- predict(gcomp_model, newdata = data_A0, type = "response") 
...
kable(results_df, format = "latex", digits = 2, 
      caption = "ATE Estimates on LaLonde   Data") |>
