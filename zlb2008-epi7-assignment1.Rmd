...
\item $A \in \{0,1\}$ is the binary intervention. $A=1$ if the individual was assigned the job training, and $A=0$ otherwise.
...
\item $=E[Y^1|A = 1,Black =1]]$ (by marginal exchangeability, $Y^a \perp A$) 
\item $= E[Y|A = 1,Black =1]]$ (by consistency)

\end{itemize}

We can replace the 1's with 0's to find $E[Y^0|Black=1]$. Thus, the causal ATE is identified by the statistical estimand: $$\hat{ATE} = \mathbb{E}[Y \mid A=1, Black = 1] - \mathbb{E}[Y \mid A=0, Black = 1]]$$
